# $ANTLR 3.1.1 SourceText.g 2010-03-04 16:18:58
...
tokenNames = [
    "<invalid>", "<EOR>", "<DOWN>", "<UP>", 
    "STRING", "CHAR", "LETTER", "WS", "COMMENT", "LT", "LINECOMMENT", "'{'", 
    "'}'"
]
...
class SourceTextParser(Parser):
        ...
        try:
            try:
                ...
                if alt3 == 1:
                    ...
                    #action end
                    char_literal3=self.match(self.input, 11, self.FOLLOW_11_in_element89)
                    ...
                    char_literal5=self.match(self.input, 12, self.FOLLOW_12_in_element97)
    ...
    FOLLOW_item_in_element69 = frozenset([11])
    FOLLOW_11_in_element89 = frozenset([4, 12])
    FOLLOW_element_in_element92 = frozenset([4, 12])
    FOLLOW_12_in_element97 = frozenset([1])
